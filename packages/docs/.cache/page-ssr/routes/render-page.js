...
var _invariant = __webpack_require__(5586);
...
var _interopRequireDefault = __webpack_require__(360);
...
var _assertThisInitialized2 = _interopRequireDefault(__webpack_require__(6637));

var _inheritsLoose2 = _interopRequireDefault(__webpack_require__(4450));

var _extends2 = _interopRequireDefault(__webpack_require__(8492));

var _propTypes = _interopRequireDefault(__webpack_require__(3980));

var _react = _interopRequireDefault(__webpack_require__(2185));

var _reachRouter = __webpack_require__(8924);

var _parsePath = __webpack_require__(3762);

exports.parsePath = _parsePath.parsePath;

var _isLocalLink = __webpack_require__(1173);

var _rewriteLinkPath = __webpack_require__(5564);
...
var _utils = __webpack_require__(6159);

var _applyTrailingSlashOption = __webpack_require__(5516);

var _parsePath2 = __webpack_require__(3762);

var _isLocalLink = __webpack_require__(1173);

var _ = __webpack_require__(6739);
...
var _scrollHandler = __webpack_require__(1415);

__webpack_unused_export__ = _scrollHandler.ScrollHandler;

var _useScrollRestoration = __webpack_require__(5492);
...
var React = _interopRequireWildcard(__webpack_require__(2185));
...
var _react = __webpack_require__(2185);
...
"use strict";
var _interopRequireDefault=__webpack_require__(360);var _path=_interopRequireDefault(__webpack_require__(1423));exports.favicons=[{src:`favicon-32x32.png`,sizes:`32x32`,type:`image/png`}];// default icons for generating icons
...
"use strict";
var _interopRequireDefault=__webpack_require__(360);var React=_interopRequireWildcard(__webpack_require__(2185));var _gatsby=__webpack_require__(2886);var _common=__webpack_require__(2085);var _getManifestPathname=_interopRequireDefault(__webpack_require__(5251));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: remove for v3
...
"use strict";
exports.__esModule=true;exports["default"]=void 0;var _gatsby=__webpack_require__(2886);/**
...
"use strict";
var React=_interopRequireWildcard(__webpack_require__(2185));var _gatsby=__webpack_require__(2886);var _path=__webpack_require__(1423);function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function _getRequireWildcardCache(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: Remove for v3 - Fix janky path/asset prefixing
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2185);
...
var defineProperty = __webpack_require__(8164);
...
var mdx_components = __webpack_require__(9608);
;// CONCATENATED MODULE: ../../node_modules/gatsby-plugin-mdx/loaders/mdx-scopes.js
var scope_0=(__webpack_require__(9811)/* ["default"] */ .Z);/* harmony default export */ const mdx_scopes = (Object.assign({},scope_0));
;// CONCATENATED MODULE: ../../node_modules/gatsby-plugin-mdx/wrap-root-element.js
function wrap_root_element_ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly){symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});}keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){wrap_root_element_ownKeys(Object(source),true).forEach(function(key){(0,defineProperty/* default */.Z)(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{wrap_root_element_ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}/**
...
exports.components={"component---src-pages-404-tsx":()=>__webpack_require__.e(/* import() | component---src-pages-404-tsx */ 218).then(__webpack_require__.bind(__webpack_require__, 4067)),"component---src-pages-index-tsx":()=>__webpack_require__.e(/* import() | component---src-pages-index-tsx */ 691).then(__webpack_require__.bind(__webpack_require__, 7554))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-react-helmet',plugin:__webpack_require__(1881),options:{"plugins":[]}},{name:'gatsby-plugin-sitemap',plugin:__webpack_require__(1189),options:{"plugins":[],"output":"/sitemap","createLinkInHead":true,"entryLimit":45000,"query":"{ site { siteMetadata { siteUrl } } allSitePage { nodes { path } } }","excludes":[]}},{name:'gatsby-plugin-mdx',plugin:__webpack_require__(7971),options:{"plugins":[],"extensions":[".mdx"],"defaultLayouts":{},"gatsbyRemarkPlugins":[],"lessBabel":false,"remarkPlugins":[],"rehypePlugins":[],"mediaTypes":["text/markdown","text/x-markdown"],"root":"/Users/patrickwolfert/Projects/design-system/packages/docs","commonmark":false}},{name:'gatsby-plugin-manifest',plugin:__webpack_require__(6424),options:{"plugins":[],"name":"CMS Design System","short_name":"CMS DS","start_url":"/","background_color":"#0071bc","theme_color":"#0071bc","display":"standalone","icon":"src/images/favicon.ico","crossOrigin":"use-credentials","legacy":true,"theme_color_in_head":true,"cache_busting_mode":"query","include_favicon":true,"cacheDigest":"90c79d265d380cf1bd725916c380e297"}}];/* global plugins */ // During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
//   },
// ]
const apis=__webpack_require__(6706);function augmentErrorWithPlugin(plugin,err){if(plugin.name!==`default-site-plugin`){// default-site-plugin is user code and will print proper stack trace,
...
var utils = __webpack_require__(6159);
...
const trimmedPathname=stripPrefix(pathname,decodeURIComponent("/hello-world"))// Remove any hashfragment
...
var public_page_renderer = __webpack_require__(9758);
...
var find_path = __webpack_require__(5155);
...
if(this.staticQueryDb[staticQueryHash]){const jsonPayload=this.staticQueryDb[staticQueryHash];return{staticQueryHash,jsonPayload};}return this.memoizedGet(`${"/hello-world"}/page-data/sq/d/${staticQueryHash}.json`).then(req=>{const jsonPayload=JSON.parse(req.responseText);return{staticQueryHash,jsonPayload};}).catch(()=>{throw new Error(`We couldn't load "${"/hello-world"}/page-data/sq/d/${staticQueryHash}.json"`);});})).then(staticQueryResults=>{const staticQueryResultsMap={};staticQueryResults.forEach(({staticQueryHash,jsonPayload})=>{staticQueryResultsMap[staticQueryHash]=jsonPayload;this.staticQueryDb[staticQueryHash]=jsonPayload;});return staticQueryResultsMap;});return Promise.all([componentChunkPromise,staticQueryBatchPromise]).then(([pageResources,staticQueryResults])=>{let payload;if(pageResources){payload=_objectSpread(_objectSpread({},pageResources),{},{staticQueryResults});finalResult.payload=payload;emitter.emit(`onPostLoadPageResources`,{page:payload,pageResources:payload});}this.pageDb.set(pagePath,finalResult);if(finalResult.error){return{error:finalResult.error,status:finalResult.status};}return payload;})// when static-query fail to load we throw a better error
...
var invariant = __webpack_require__(5586);
var invariant_default = /*#__PURE__*/__webpack_require__.n(invariant);
// EXTERNAL MODULE: ./.cache/react-lifecycles-compat.js
var react_lifecycles_compat = __webpack_require__(9465);
...
var setPrototypeOf = __webpack_require__(2497);
...
/* harmony export */ });
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3980);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_side_effect__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7512);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2185);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var object_assign__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7728);
...
var React = __webpack_require__(2185);
...
"use strict";
module.exports = require("/Users/patrickwolfert/Projects/design-system/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/Users/patrickwolfert/Projects/design-system/node_modules/react/index.js");
...
"use strict";
module.exports = require("/Users/patrickwolfert/Projects/design-system/packages/docs/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = JSON.parse('{"polyfill":["/polyfill-f514bf760ab29546c598.js"],"app":["/app-2111643be4e5b5a7f5f4.js"],"component---src-pages-404-tsx":["/component---src-pages-404-tsx-7e993c3eb53bcea55d11.js"],"component---src-pages-index-tsx":["/component---src-pages-index-tsx-750b9e6fe50381782a31.js"]}');
...
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8164);
function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly){symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});}keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(Object(source),true).forEach(function(key){(0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}/* global HAS_REACT_18 */const React=__webpack_require__(2185);const path=__webpack_require__(1423);const{renderToString,renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(3304);const{ServerLocation,Router,isRedirect}=__webpack_require__(8924);const merge=__webpack_require__(9714);const{StaticQueryContext}=__webpack_require__(2886);const fs=__webpack_require__(123);const{WritableAsPromise}=__webpack_require__(4126);const{RouteAnnouncerProps}=__webpack_require__(1133);const{apiRunner,apiRunnerAsync}=__webpack_require__(5485);const asyncRequires=__webpack_require__(6849);const{version:gatsbyVersion}=__webpack_require__(5872);const{grabMatchParams}=__webpack_require__(5155);const chunkMapping=__webpack_require__(9804);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
const{join}=path.posix;// const testRequireError = require("./test-require-error")
// For some extremely mysterious reason, webpack adds the above module *after*
// this module so that when this code runs, testRequireError is undefined.
// So in the meantime, we'll just inline it.
const testRequireError=(moduleName,err)=>{const regex=new RegExp(`Error: Cannot find module\\s.${moduleName}`);const firstLine=err.toString().split(`\n`)[0];return regex.test(firstLine);};let Html;try{Html=__webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../src/html'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));}catch(err){if(testRequireError(`../src/html`,err)){Html=__webpack_require__(2880);}else{throw err;}}Html=Html&&Html.__esModule?Html.default:Html;const getPageDataPath=path=>{const fixedPagePath=path===`/`?`index`:path;return join(`page-data`,fixedPagePath,`page-data.json`);};const getPageDataUrl=pagePath=>{const pageDataPath=getPageDataPath(pagePath);return`${"/hello-world"}/${pageDataPath}`;};const getStaticQueryPath=hash=>join(`page-data`,`sq`,`d`,`${hash}.json`);const getStaticQueryUrl=hash=>`${"/hello-world"}/${getStaticQueryPath(hash)}`;const getAppDataUrl=()=>`${"/hello-world"}/${join(`page-data`,`app-data.json`)}`;const createElement=React.createElement;const sanitizeComponents=components=>{const componentsArray=[].concat(components).flat(Infinity).filter(Boolean);return componentsArray.map(component=>{// Ensure manifest is always loaded from content server
